...
_EXPORT_MODULES = {  # Explanation: maps public chemistry names to the submodule that defines each name.
    ...
    "FunctionalGroupInstance": "kgcl_retro.chemistry.fg_instances",  # Explanation: resolves contextual FG instance metadata lazily.
    "match_fg_instances": "kgcl_retro.chemistry.fg_instances",  # Explanation: resolves contextual FG occurrence matching lazily.
