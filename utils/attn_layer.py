...
from kgcl_retro.models.encoder import FeedForward, Global_Attention, MultiHeadAttention  # Explanation: re-exports packaged attention layers through the old utils path.

__all__ = ["FeedForward", "Global_Attention", "MultiHeadAttention"]  # Explanation: defines the legacy module API.
